...
fname_train = f'{TMP_DIR}/train_patches63.dat'
fname_val = f'{TMP_DIR}/val_patches63.dat'

model_desc="Jun17_patch64_4layers_diceCE" #  put current date if training, test if just testing
...
if not os.path.exists(f'/scratch/athurai3/monai_outputs/UNET/{model_desc}'):
    ...
    shutil.copy(f'/scratch/athurai3/sandbox_contact_seg/monai_c3d_dice64.py', f'/scratch/athurai3/monai_outputs/UNET/{model_desc}')
