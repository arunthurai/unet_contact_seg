...
fname = 'projects/ctb-akhanf/athurai3/contact_localization/sub-P001_prob_patches.dat'
...
fname_val = 'projects/ctb-akhanf/athurai3/contact_localization/sub-P002_prob_patches.dat'
...
train_loader = DataLoader(train_patches_dataset, batch_size=batch_size, shuffle=False, num_workers=32) #num_workers is number of cpus we request
...
for epoch in range(max_epochs):
    ...
    for batch_data in train_loader:
        ...
        loss = mean_abs_error(outputs, labels)
        print(loss)
        loss.backward()
        optimizer.step()
    ...
    with torch.no_grad():
        ...
        for val_data in val_loader:
            ...
            val_loss = mean_abs_error(val_outputs, val_images)
